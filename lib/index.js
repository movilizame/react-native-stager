...
import { View, ScrollView, InteractionManager, StyleSheet, Button, Dimensions } from 'react-native';
...
export class Stage extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(View, null,
            React.createElement(ScrollView, { keyboardShouldPersistTaps: 'handled', contentContainerStyle: styles.scrollviewContainer, style: [styles.scrollview, this.props.maxHeight ? { maxHeight: this.props.maxHeight() } : {}] }, children(this.passProps))));
    }
}
Stage.contextTypes = {
    fn: PropTypes.any
